...
export type {
  ...
  FGTSInput,
  FGTSOutput,
  VerbasRescisoriasInput,
  VerbasRescisoriasOutput,
  HorasExtrasInput,
  HorasExtrasOutput,
  AdicionalNoturnoInput,
  AdicionalNoturnoOutput,
  FeriasInput,
  FeriasOutput,
  DecimoTerceiroInput,
  DecimoTerceiroOutput,
  AvisoPrevioInput,
  AvisoPrevioOutput,
} from './trabalhista';
...
export type {
  ...
  RMIInput,
  RMIOutput,
  RevisaoVidaTodaInput,
  RevisaoVidaTodaOutput,
} from './previdenciario';

export type {
  // Família
  PensaoAlimenticiaInput,
  PensaoAlimenticiaOutput,
  DivorcioInput,
  DivorcioOutput,
  GuardaCompartilhadaInput,
  GuardaCompartilhadaOutput,
} from './familia';
...
export type {
  ...
  JurosMoratoriosInput,
  JurosMoratoriosOutput,
  DanosMoraisInput,
  DanosMoraisOutput,
  LiquidacaoInput,
  LiquidacaoOutput,
